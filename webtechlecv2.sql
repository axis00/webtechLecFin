...
CREATE TABLE `quiz` (
  ...
  `q_last` int(11) NOT NULL,
  `score` int(11) NOT NULL DEFAULT '0',
  `stat` enum('done','inprog') NOT NULL,
  PRIMARY KEY (`idquiz`),
  KEY `q_user_idx` (`q_user`),
  KEY `q_last_idx` (`q_last`),
  CONSTRAINT `q_last` FOREIGN KEY (`q_last`) REFERENCES `questions` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2018-05-12 13:28:48
